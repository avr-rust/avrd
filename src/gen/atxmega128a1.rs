//! The AVR ATxmega128A1 microcontroller
//!
//! # Variants
//! |        | Pinout | Mcu age | Operating temperature | Operating voltage | Max speed |
//! |--------|--------|---------|-----------------------|-------------------|-----------|
//! | ATXMEGA128A1-AU |  | TQFP100 | 0°C - 0°C | 1.6V - 3.6V | 32 MHz |
//! | ATXMEGA128A1-CU |  | CBGA100 | 0°C - 0°C | 1.6V - 3.6V | 32 MHz |
//!
...
/// | SDROW | 100 |
/// | SDCOL | 11 |
pub const SDRAMCTRLA: *mut u8 = 0x1 as *mut u8;
...
pub const BASEADDR: *mut u16 = 0x2 as *mut u16;
...
/// Chip Select Base Address low byte.
pub const BASEADDRL: *mut u8 = 0x2 as *mut u8;
...
/// Chip Select Base Address high byte.
pub const BASEADDRH: *mut u8 = 0x3 as *mut u8;
...
pub const REFRESH: *mut u16 = 0x4 as *mut u16;
...
/// | ---- | ------------- |
/// | CONINTVAL | 1110000 |
pub const TIMCTRL: *mut u8 = 0x4 as *mut u8;
...
pub const INTCTRL: *mut u8 = 0x4 as *mut u8;
...
pub const REFRESHL: *mut u8 = 0x4 as *mut u8;
...
pub const REFRESHH: *mut u8 = 0x5 as *mut u8;
...
/// SDRAM Initialization Delay low byte.
pub const INITDLYL: *mut u8 = 0x6 as *mut u8;
...
pub const INITDLY: *mut u16 = 0x6 as *mut u16;
...
/// SDRAM Initialization Delay high byte.
pub const INITDLYH: *mut u8 = 0x7 as *mut u8;
...
/// | RPDLY | 111 |
/// | ROWCYCDLY | 111000 |
pub const SDRAMCTRLB: *mut u8 = 0x8 as *mut u8;

/// Gain Calibration.
pub const GAINCAL: *mut u8 = 0x8 as *mut u8;

/// Ramp D.
pub const RAMPD: *mut u8 = 0x8 as *mut u8;

/// Offset Calibration.
pub const OFFSETCAL: *mut u8 = 0x9 as *mut u8;
...
/// | ROWCOLDLY | 111 |
/// | ESRDLY | 111000 |
pub const SDRAMCTRLC: *mut u8 = 0x9 as *mut u8;
...
pub const DACAOFFCAL: *mut u8 = 0x30 as *mut u8;

/// DACA Calibration Byte 1.
pub const DACAGAINCAL: *mut u8 = 0x31 as *mut u8;

/// DACB Calibration Byte 0.
pub const DACBOFFCAL: *mut u8 = 0x32 as *mut u8;

/// DACB Calibration Byte 1.
pub const DACBGAINCAL: *mut u8 = 0x33 as *mut u8;
...
/// Bitfield on register `CTRL`
pub const XOR: *mut u8 = 0x4 as *mut u8;

/// Bitfield on register `CTRL`
pub const RESET: *mut u8 = 0x20 as *mut u8;

/// Bitfield on register `CTRL`
pub const DECRYPT: *mut u8 = 0x10 as *mut u8;

/// Bitfield on register `CTRL`
pub const AUTO: *mut u8 = 0x40 as *mut u8;

/// Bitfield on register `CTRL`
pub const START: *mut u8 = 0x80 as *mut u8;
...
pub const BYTEM: *mut u8 = 0x1 as *mut u8;
...
/// Bitfield on register `MUXCTRL`
pub const MUXNEGL: *mut u8 = 0x3 as *mut u8;

/// Bitfield on register `MUXCTRL`
pub const MUXNEGH: *mut u8 = 0x3 as *mut u8;
...
/// Bitfield on register `PRGEN`
pub const EBI: *mut u8 = 0x8 as *mut u8;
...
/// Bitfield on register `REFCTRL`
pub const REFSEL: *mut u8 = 0x30 as *mut u8;
...
/// Bitfield on register `SDRAMCTRLA`
pub const SDCAS: *mut u8 = 0x8 as *mut u8;

/// Bitfield on register `SDRAMCTRLA`
pub const SDROW: *mut u8 = 0x4 as *mut u8;

/// Bitfield on register `SDRAMCTRLA`
pub const SDCOL: *mut u8 = 0x3 as *mut u8;

/// Bitfield on register `SDRAMCTRLB`
pub const MRDLY: *mut u8 = 0xC0 as *mut u8;

/// Bitfield on register `SDRAMCTRLB`
pub const RPDLY: *mut u8 = 0x7 as *mut u8;

/// Bitfield on register `SDRAMCTRLB`
pub const ROWCYCDLY: *mut u8 = 0x38 as *mut u8;

/// Bitfield on register `SDRAMCTRLC`
pub const WRDLY: *mut u8 = 0xC0 as *mut u8;

/// Bitfield on register `SDRAMCTRLC`
pub const ROWCOLDLY: *mut u8 = 0x7 as *mut u8;

/// Bitfield on register `SDRAMCTRLC`
pub const ESRDLY: *mut u8 = 0x38 as *mut u8;
...
pub const ERROR: *mut u8 = 0x80 as *mut u8;

/// Bitfield on register `STATUS`
pub const SRIF: *mut u8 = 0x1 as *mut u8;

/// Bitfield on register `TIMCTRL`
pub const CONINTVAL: *mut u8 = 0x70 as *mut u8;
...
pub mod bodlvl {
   ...
   /// 1.9 V.
   pub const _1V9: u32 = 0x6;
   /// 2.1 V.
   pub const _2V1: u32 = 0x5;
   /// 2.4 V.
   pub const _2V4: u32 = 0x4;
   /// 2.6 V.
   pub const _2V6: u32 = 0x3;
   /// 2.9 V.
   pub const _2V9: u32 = 0x2;
   /// 3.2 V.
   pub const _3V2: u32 = 0x1;
   /// 3.4 V.
   pub const _3V4: u32 = 0x0;
}
...
/// Conversion interval
#[allow(non_upper_case_globals)]
pub mod dac_conintval {
   /// 1 CLK / 2 CLK in S/H mode.
   pub const _1CLK: u32 = 0x0;
   /// 2 CLK / 3 CLK in S/H mode.
   pub const _2CLK: u32 = 0x1;
   /// 4 CLK / 6 CLK in S/H mode.
   pub const _4CLK: u32 = 0x2;
   /// 8 CLK / 12 CLK in S/H mode.
   pub const _8CLK: u32 = 0x3;
   /// 16 CLK / 24 CLK in S/H mode.
   pub const _16CLK: u32 = 0x4;
   /// 32 CLK / 48 CLK in S/H mode.
   pub const _32CLK: u32 = 0x5;
   /// 64 CLK / 96 CLK in S/H mode.
   pub const _64CLK: u32 = 0x6;
   /// 128 CLK / 192 CLK in S/H mode.
   pub const _128CLK: u32 = 0x7;
}
...
pub mod dac_refresh {
   /// 16 CLK.
   pub const _16CLK: u32 = 0x0;
   /// 32 CLK.
   pub const _32CLK: u32 = 0x1;
   /// 64 CLK.
   pub const _64CLK: u32 = 0x2;
   /// 128 CLK.
   pub const _128CLK: u32 = 0x3;
   /// 256 CLK.
   pub const _256CLK: u32 = 0x4;
   /// 512 CLK.
   pub const _512CLK: u32 = 0x5;
   /// 1024 CLK.
   pub const _1024CLK: u32 = 0x6;
   /// 2048 CLK.
   pub const _2048CLK: u32 = 0x7;
   /// 4096 CLK.
   pub const _4096CLK: u32 = 0x8;
   /// 8192 CLK.
   pub const _8192CLK: u32 = 0x9;
   /// 16384 CLK.
   pub const _16384CLK: u32 = 0xA;
   /// 32768 CLK.
   pub const _32768CLK: u32 = 0xB;
   /// 65536 CLK.
   pub const _65536CLK: u32 = 0xC;
   /// Auto refresh OFF.
   pub const OFF: u32 = 0xF;
}
...
#[allow(non_upper_case_globals)]
pub mod ebi_cs_asize {
   /// 256 bytes.
   pub const _256B: u32 = 0x0;
   /// 512 bytes.
   pub const _512B: u32 = 0x1;
   /// 1K bytes.
   pub const _1KB: u32 = 0x2;
   /// 2K bytes.
   pub const _2KB: u32 = 0x3;
   /// 4K bytes.
   pub const _4KB: u32 = 0x4;
   /// 8K bytes.
   pub const _8KB: u32 = 0x5;
   /// 16K bytes.
   pub const _16KB: u32 = 0x6;
   /// 32K bytes.
   pub const _32KB: u32 = 0x7;
   /// 64K bytes.
   pub const _64KB: u32 = 0x8;
   /// 128K bytes.
   pub const _128KB: u32 = 0x9;
   /// 256K bytes.
   pub const _256KB: u32 = 0xA;
   /// 512K bytes.
   pub const _512KB: u32 = 0xB;
   /// 1M bytes.
   pub const _1MB: u32 = 0xC;
   /// 2M bytes.
   pub const _2MB: u32 = 0xD;
   /// 4M bytes.
   pub const _4MB: u32 = 0xE;
   /// 8M bytes.
   pub const _8MB: u32 = 0xF;
   /// 16M bytes.
   pub const _16M: u32 = 0x10;
}
...
pub mod ebi_cs_mode {
   ...
   pub const DISABLED: u32 = 0x0;
   /// Chip Select in SRAM mode.
   pub const SRAM: u32 = 0x1;
   /// Chip Select in SRAM LPC mode.
   pub const LPC: u32 = 0x2;
   /// Chip Select in SDRAM mode.
   pub const SDRAM: u32 = 0x3;
}

/// Chip Select SDRAM mode
#[allow(non_upper_case_globals)]
pub mod ebi_cs_sdmode {
   /// Normal mode.
   pub const NORMAL: u32 = 0x0;
   /// Load Mode Register command mode.
...
pub mod ebi_cs_srws {
   /// 0 cycles.
   pub const _0CLK: u32 = 0x0;
   /// 1 cycle.
   pub const _1CLK: u32 = 0x1;
   /// 2 cycles.
   pub const _2CLK: u32 = 0x2;
   /// 3 cycles.
   pub const _3CLK: u32 = 0x3;
   /// 4 cycles.
   pub const _4CLK: u32 = 0x4;
   /// 5 cycles.
   pub const _5CLK: u32 = 0x5;
   /// 6 cycles.
   pub const _6CLK: u32 = 0x6;
   /// 7 cycles.
   pub const _7CLK: u32 = 0x7;
}
...
/// `EBI_IFMODE` value group
#[allow(non_upper_case_globals)]
pub mod ebi_ifmode {
   /// EBI Disabled.
   pub const DISABLED: u32 = 0x0;
   /// 3-port mode.
   pub const _3PORT: u32 = 0x1;
   /// 4-port mode.
   pub const _4PORT: u32 = 0x2;
   /// 2-port mode.
   pub const _2PORT: u32 = 0x3;
}

/// `EBI_LPCMODE` value group
#[allow(non_upper_case_globals)]
pub mod ebi_lpcmode {
   /// Data muxed with addr byte 0.
   pub const ALE1: u32 = 0x0;
   /// Data muxed with addr byte 0 and 1.
   pub const ALE12: u32 = 0x2;
}
...
/// `EBI_SDCOL` value group
#[allow(non_upper_case_globals)]
pub mod ebi_sdcol {
   /// 8 column bits.
   pub const _8BIT: u32 = 0x0;
   /// 9 column bits.
   pub const _9BIT: u32 = 0x1;
   /// 10 column bits.
   pub const _10BIT: u32 = 0x2;
   /// 11 column bits.
   pub const _11BIT: u32 = 0x3;
}

/// `EBI_SDDATAW` value group
#[allow(non_upper_case_globals)]
pub mod ebi_sddataw {
   /// 4-bit data bus.
   pub const _4BIT: u32 = 0x0;
   /// 8-bit data bus.
   pub const _8BIT: u32 = 0x1;
}

/// `EBI_SRMODE` value group
#[allow(non_upper_case_globals)]
pub mod ebi_srmode {
   /// Addr byte 0 muxed with 1.
   pub const ALE1: u32 = 0x0;
   /// Addr byte 0 muxed with 2.
   pub const ALE2: u32 = 0x1;
   /// Addr byte 0 muxed with 1 and 2.
   pub const ALE12: u32 = 0x2;
   /// No addr muxing.
   pub const NOALE: u32 = 0x3;
}
