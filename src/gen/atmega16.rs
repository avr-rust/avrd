//! The AVR ATmega16 microcontroller
//!
//! # Variants
//! |        | Pinout | Mcu age | Operating temperature | Operating voltage | Max speed |
//! |--------|--------|---------|-----------------------|-------------------|-----------|
//! | ATmega16L-8AU | TQFPQFN44 | TQFP44 | -40°C - 85°C | 2.7V - 5.5V | 8 MHz |
//! | ATmega16L-8PU | PDIP40 | PDIP40 | -40°C - 85°C | 2.7V - 5.5V | 8 MHz |
//! | ATmega16L-8MU | TQFPQFN44 | QFN44 | -40°C - 85°C | 2.7V - 5.5V | 8 MHz |
//! | ATmega16-16AU | TQFPQFN44 | TQFP44 | -40°C - 85°C | 4.5V - 5.5V | 16 MHz |
//! | ATmega16-16PU | PDIP40 | PDIP40 | -40°C - 85°C | 4.5V - 5.5V | 16 MHz |
//! | ATmega16-16MU | TQFPQFN44 | QFN44 | -40°C - 85°C | 4.5V - 5.5V | 16 MHz |
//!
...
pub const ADTS: *mut u8 = 0xE0 as *mut u8;
...
pub mod cpu_sleep_mode_3bits {
   ...
   /// Reserved.
   pub const VAL_0x04: u32 = 0x8;
   /// Reserved.
   pub const VAL_0x05: u32 = 0x9;
   /// Standby.
   pub const STDBY: u32 = 0xA;
   /// Extended Standby.
   pub const ESTDBY: u32 = 0xB;
}
