//! The AVR ATtiny40 microcontroller
//!
//! # Variants
//! |        | Pinout | Mcu age | Operating temperature | Operating voltage | Max speed |
//! |--------|--------|---------|-----------------------|-------------------|-----------|
//! | ATtiny40-SU | DIP | SOIC20 | -40°C - 85°C | 1.8V - 5.5V | 12 MHz |
//! | ATtiny40-XU | DIP | TSSOP20 | -40°C - 85°C | 1.8V - 5.5V | 12 MHz |
//! | ATtiny40-MMH | VQFN | VQFN20 | -40°C - 85°C | 1.8V - 5.5V | 12 MHz |
//!
...
pub const PCMSK2: *mut u8 = 0x1A as *mut u8;

/// Port C Input Pins.
pub const PINC: *mut u8 = 0x1B as *mut u8;

/// Data Direction Register, Port C.
pub const DDRC: *mut u8 = 0x1C as *mut u8;

/// Port C Data Register.
pub const PORTC: *mut u8 = 0x1D as *mut u8;

/// Pull-up Enable Control Register.
pub const PUEC: *mut u8 = 0x1E as *mut u8;

/// RAM Data Register.
pub const RAMDR: *mut u8 = 0x1F as *mut u8;

/// RAM Address Register.
pub const RAMAR: *mut u8 = 0x20 as *mut u8;

/// Timer/Counter 1 Output Compare Register B.
pub const OCR1B: *mut u8 = 0x21 as *mut u8;

/// Timer/Counter 1 Output Compare Register A.
pub const OCR1A: *mut u8 = 0x22 as *mut u8;

/// Timer/Counter1 Low.
pub const TCNT1L: *mut u8 = 0x23 as *mut u8;
...
/// Timer/Counter1 High.
pub const TCNT1H: *mut u8 = 0x27 as *mut u8;
...
/// Bitfield on register `GIFR`
pub const PCIF: *mut u8 = 0x70 as *mut u8;

/// Bitfield on register `GIMSK`
pub const INT0: *mut u8 = 0x1 as *mut u8;

/// Bitfield on register `GIMSK`
pub const PCIE: *mut u8 = 0x70 as *mut u8;
...
/// Bitfield on register `TCCR0B`
pub const TSM: *mut u8 = 0x20 as *mut u8;

/// Bitfield on register `TCCR0B`
pub const FOC0A: *mut u8 = 0x80 as *mut u8;

/// Bitfield on register `TCCR0B`
pub const PSR: *mut u8 = 0x10 as *mut u8;
...
pub mod adc_mux {
   ...
   /// ADC11.
   pub const ADC11: u32 = 0xB;
   /// 0V (AGND).
   pub const ADC_GND: u32 = 0xC;
   /// 1.1V Internal Reference.
   pub const ADC_VBG: u32 = 0xD;
   /// Temperature sensor.
   pub const TEMPSENS: u32 = 0xE;
}
