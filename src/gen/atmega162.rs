//! The AVR ATmega162 microcontroller
//!
//! # Variants
...
pub const UBRR1L: *mut u8 = 0x20 as *mut u8;
...
/// | TXCIE1 | 1000000 |
/// | RXB81 | 10 |
pub const UCSR1B: *mut u8 = 0x21 as *mut u8;
...
/// | U2X1 | 10 |
/// | DOR1 | 1000 |
pub const UCSR1A: *mut u8 = 0x22 as *mut u8;

/// USART I/O Data Register.
pub const UDR1: *mut u8 = 0x23 as *mut u8;

/// On-Chip Debug Related Register in I/O Memory.
pub const OCDR: *mut u8 = 0x24 as *mut u8;
...
pub const UBRR0H: *mut u8 = 0x40 as *mut u8;
...
/// | USBS0 | 1000 |
/// | UMSEL0 | 1000000 |
pub const UCSR0C: *mut u8 = 0x40 as *mut u8;
...
pub const OCR2: *mut u8 = 0x42 as *mut u8;

/// Timer/Counter Register.
pub const TCNT2: *mut u8 = 0x43 as *mut u8;
...
/// | TCR2UB | 1 |
/// | OCR2UB | 10 |
pub const ASSR: *mut u8 = 0x46 as *mut u8;
...
/// | WGM20 | 1000000 |
/// | FOC2 | 10000000 |
pub const TCCR2: *mut u8 = 0x47 as *mut u8;
...
pub const UBRR1H: *mut u8 = 0x5C as *mut u8;
...
/// | URSEL1 | 10000000 |
/// | UMSEL1 | 1000000 |
pub const UCSR1C: *mut u8 = 0x5C as *mut u8;
...
/// Timer/Counte3 Output Compare Register B  Bytes low byte.
...
/// Timer/Counte3 Output Compare Register B  Bytes high byte.
...
pub const M161C: *mut u8 = 0x10 as *mut u8;
...
/// Bitfield on register `GICR`
pub const PCIE: *mut u8 = 0x18 as *mut u8;
...
/// Bitfield on register `GIFR`
pub const PCIF: *mut u8 = 0x18 as *mut u8;
...
/// Bitfield on register `SFIOR`
pub const PSR310: *mut u8 = 0x1 as *mut u8;
...
/// Bitfield on register `TCCR3A`
pub const FOC3A: *mut u8 = 0x8 as *mut u8;

/// Bitfield on register `TCCR3A`
pub const COM3A: *mut u8 = 0xC0 as *mut u8;

/// Bitfield on register `TCCR3A`
pub const FOC3B: *mut u8 = 0x4 as *mut u8;
...
/// Bitfield on register `TIFR`
pub const OCF0: *mut u8 = 0x1 as *mut u8;

/// Bitfield on register `TIMSK`
pub const OCIE0: *mut u8 = 0x1 as *mut u8;
...
/// Bitfield on register `UCSR1C`
pub const URSEL1: *mut u8 = 0x80 as *mut u8;
...
/// `CLK_SEL_3BIT_SWAPPED` value group
#[allow(non_upper_case_globals)]
pub mod clk_sel_3bit_swapped {
   /// No Clock Source (Stopped).
   pub const VAL_0x00: u32 = 0x0;
   /// Running, No Prescaling.
   pub const VAL_0x01: u32 = 0x1;
