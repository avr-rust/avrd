//! The AVR ATmega128RFA1 microcontroller
//!
//! # Variants
...
pub mod batmon_vth_bitf {
   /// 2.550V (BATMON_HR=1) 1.70V (BATMON_HR=0).
   pub const VAL_0x0: u32 = 0x0;
   /// 2.625V (BATMON_HR=1) 1.75V (BATMON_HR=0).
   pub const VAL_0x1: u32 = 0x1;
   /// 2.700V (BATMON_HR=1) 1.80V (BATMON_HR=0).
   pub const VAL_0x2: u32 = 0x2;
   /// 2.775V (BATMON_HR=1) 1.85V (BATMON_HR=0).
   pub const VAL_0x3: u32 = 0x3;
   /// 2.850V (BATMON_HR=1) 1.90V (BATMON_HR=0).
   pub const VAL_0x4: u32 = 0x4;
   /// 2.925V (BATMON_HR=1) 1.95V (BATMON_HR=0).
   pub const VAL_0x5: u32 = 0x5;
   /// 3.000V (BATMON_HR=1) 2.00V (BATMON_HR=0).
   pub const VAL_0x6: u32 = 0x6;
   /// 3.075V (BATMON_HR=1) 2.05V (BATMON_HR=0).
   pub const VAL_0x7: u32 = 0x7;
   /// 3.150V (BATMON_HR=1) 2.10V (BATMON_HR=0).
   pub const VAL_0x8: u32 = 0x8;
   /// 3.225V (BATMON_HR=1) 2.15V (BATMON_HR=0).
   pub const VAL_0x9: u32 = 0x9;
   /// 3.300V (BATMON_HR=1) 2.20V (BATMON_HR=0).
   pub const VAL_0xA: u32 = 0xA;
   /// 3.375V (BATMON_HR=1) 2.25V (BATMON_HR=0).
   pub const VAL_0xB: u32 = 0xB;
   /// 3.450V (BATMON_HR=1) 2.30V (BATMON_HR=0).
   pub const VAL_0xC: u32 = 0xC;
   /// 3.525V (BATMON_HR=1) 2.35V (BATMON_HR=0).
   pub const VAL_0xD: u32 = 0xD;
   /// 3.600V (BATMON_HR=1) 2.40V (BATMON_HR=0).
   pub const VAL_0xE: u32 = 0xE;
   /// 3.675V (BATMON_HR=1) 2.45V (BATMON_HR=0).
