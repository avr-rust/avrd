//! The AVR ATmega324P microcontroller
//!
//! # Variants
//! |        | Pinout | Mcu age | Operating temperature | Operating voltage | Max speed |
//! |--------|--------|---------|-----------------------|-------------------|-----------|
//! | ATmega324PV-10AU | TQFP-VQFN-44 | TQFP44 | -40°C - 85°C | 1.8V - 5.5V | 10 MHz |
//! | ATmega324PV-10PU | PDIP40 | PDIP40 | -40°C - 85°C | 1.8V - 5.5V | 10 MHz |
//! | ATmega324PV-10MU | TQFP-VQFN-44 | VQFN44 | -40°C - 85°C | 1.8V - 5.5V | 10 MHz |
//! | ATmega324P-20AU | TQFP-VQFN-44 | TQFP44 | -40°C - 85°C | 2.7V - 5.5V | 20 MHz |
//! | ATmega324P-20PU | PDIP40 | PDIP40 | -40°C - 85°C | 2.7V - 5.5V | 20 MHz |
//! | ATmega324P-20MU | TQFP-VQFN-44 | VQFN44 | -40°C - 85°C | 2.7V - 5.5V | 20 MHz |
//! | ATmega324PV-10AN | TQFP-VQFN-44 | TQFP44 | -40°C - 105°C | 1.8V - 5.5V | 10 MHz |
//! | ATmega324PV-10PN | PDIP40 | PDIP40 | -40°C - 105°C | 1.8V - 5.5V | 10 MHz |
//! | ATmega324PV-10MN | TQFP-VQFN-44 | VQFN44 | -40°C - 105°C | 1.8V - 5.5V | 10 MHz |
//! | ATmega324P-20AN | TQFP-VQFN-44 | TQFP44 | -40°C - 105°C | 2.7V - 5.5V | 20 MHz |
//! | ATmega324P-20PN | PDIP40 | PDIP40 | -40°C - 105°C | 2.7V - 5.5V | 20 MHz |
//! | ATmega324P-20MN | TQFP-VQFN-44 | VQFN44 | -40°C - 105°C | 2.7V - 5.5V | 20 MHz |
//!
...
pub const DORD0: *mut u8 = 0x20 as *mut u8;

/// Bitfield on register `SPCR0`
pub const SPR10: *mut u8 = 0x2 as *mut u8;

/// Bitfield on register `SPCR0`
pub const SPE0: *mut u8 = 0x40 as *mut u8;

/// Bitfield on register `SPCR0`
pub const CPOL0: *mut u8 = 0x8 as *mut u8;

/// Bitfield on register `SPCR0`
pub const SPR00: *mut u8 = 0x1 as *mut u8;

/// Bitfield on register `SPCR0`
pub const MSTR0: *mut u8 = 0x10 as *mut u8;

/// Bitfield on register `SPCR0`
pub const SPIE0: *mut u8 = 0x80 as *mut u8;

/// Bitfield on register `SPCR0`
pub const CPHA0: *mut u8 = 0x4 as *mut u8;
...
pub const SPI2X0: *mut u8 = 0x1 as *mut u8;

/// Bitfield on register `SPSR0`
pub const SPIF0: *mut u8 = 0x80 as *mut u8;

/// Bitfield on register `SPSR0`
pub const WCOL0: *mut u8 = 0x40 as *mut u8;
