//! The AVR ATmega169P microcontroller
//!
//! # Variants
//! |        | Pinout | Mcu age | Operating temperature | Operating voltage | Max speed |
//! |--------|--------|---------|-----------------------|-------------------|-----------|
//! | ATmega169PV-8AU | TQFP64 | TQFP64 | -40°C - 85°C | 1.8V - 5.5V | 8 MHz |
//! | ATmega169PV-8MU | QFN64 | QFN64 | -40°C - 85°C | 1.8V - 5.5V | 8 MHz |
//! | ATmega169PV-8MCH | DRQFN64 | DRQFN64 | -40°C - 85°C | 1.8V - 5.5V | 8 MHz |
//! | ATmega169P-16AU | TQFP64 | TQFP64 | -40°C - 85°C | 2.7V - 5.5V | 16 MHz |
//! | ATmega169P-16MU | QFN64 | QFN64 | -40°C - 85°C | 2.7V - 5.5V | 16 MHz |
//! | ATmega169P-16MCH | DRQFN64 | DRQFN64 | -40°C - 85°C | 2.7V - 5.5V | 16 MHz |
//!
...
pub const PCIF: *mut u8 = 0xC0 as *mut u8;

/// Bitfield on register `EIFR`
pub const INTF0: *mut u8 = 0x1 as *mut u8;

/// Bitfield on register `EIMSK`
pub const PCIE: *mut u8 = 0xC0 as *mut u8;
