//! The AVR ATxmega256A3B microcontroller
//!
//! # Variants
//! |        | Pinout | Mcu age | Operating temperature | Operating voltage | Max speed |
//! |--------|--------|---------|-----------------------|-------------------|-----------|
//! | ATXMEGA256A3B-AU |  | TQFP64 | 0°C - 0°C | 1.6V - 3.6V | 32 MHz |
//! | ATXMEGA256A3B-MU |  | QFN64 | 0°C - 0°C | 1.6V - 3.6V | 32 MHz |
//!
...
pub const XOSCEN: *mut u8 = 0x8 as *mut u8;

/// Bitfield on register `CTRL`
pub const HIGHESR: *mut u8 = 0x20 as *mut u8;

/// Bitfield on register `CTRL`
pub const RESET: *mut u8 = 0x1 as *mut u8;

/// Bitfield on register `CTRL`
pub const ACCEN: *mut u8 = 0x2 as *mut u8;
...
pub const BBPORF: *mut u8 = 0x1 as *mut u8;

/// Bitfield on register `STATUS`
pub const BBPWR: *mut u8 = 0x80 as *mut u8;

/// Bitfield on register `STATUS`
pub const XOSCRDY: *mut u8 = 0x8 as *mut u8;

/// Bitfield on register `STATUS`
pub const BBBORF: *mut u8 = 0x2 as *mut u8;
...
pub const REFRESH: *mut u8 = 0xF as *mut u8;
...
pub mod nvm_cmd {
   ...
   pub const FLASH_RANGE_CRC: u32 = 0x78;
}
