//! The AVR ATxmega128A1U microcontroller
//!
//! # Variants
//! |        | Pinout | Mcu age | Operating temperature | Operating voltage | Max speed |
//! |--------|--------|---------|-----------------------|-------------------|-----------|
//! | ATxmega128A1U-AU | TQFP100 | TQFP100 | -40°C - 85°C | 1.6V - 3.6V | 32 MHz |
//! | ATxmega128A1U-CU | BGA100 | BGA100 | -40°C - 85°C | 1.6V - 3.6V | 32 MHz |
//! | ATxmega128A1U-C7U | BGA100 | BGA100 | -40°C - 85°C | 1.6V - 3.6V | 32 MHz |
//! | ATxmega128A1U-AN | TQFP100 | TQFP100 | -40°C - 105°C | 1.6V - 3.6V | 32 MHz |
//!
...
/// | EBICSOUT | 11 |
/// | EBIADROUT | 1100 |
pub const EBIOUT: *mut u8 = 0x5 as *mut u8;
...
pub const CURRENT: *mut u8 = 0x80 as *mut u8;
...
/// Bitfield on register `EBIOUT`
pub const EBICSOUT: *mut u8 = 0x3 as *mut u8;

/// Bitfield on register `EBIOUT`
pub const EBIADROUT: *mut u8 = 0xC as *mut u8;
...
#[allow(non_upper_case_globals)]
pub mod portcfg_ebiadrout {
   /// EBI port 3 address output on PORTF pins 0 to 7.
   pub const PF: u32 = 0x0;
   /// EBI port 3 address output on PORTE pins 0 to 7.
   pub const PE: u32 = 0x1;
   /// EBI port 3 address output on PORTF pins 4 to 7.
   pub const PFH: u32 = 0x2;
   /// EBI port 3 address output on PORTE pins 4 to 7.
   pub const PEH: u32 = 0x3;
}

/// EBI Chip Select Output Port
#[allow(non_upper_case_globals)]
pub mod portcfg_ebicsout {
   /// EBI chip select output to PORTH pin 4 to 7.
   pub const PH: u32 = 0x0;
   /// EBI chip select output to PORTL pin 4 to 7.
   pub const PL: u32 = 0x1;
   /// EBI chip select output to PORTF pin 4 to 7.
   pub const PF: u32 = 0x2;
