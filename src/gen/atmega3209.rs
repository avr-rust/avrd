//! The AVR ATmega3209 microcontroller
//!
//! # Variants
//! |        | Pinout | Mcu age | Operating temperature | Operating voltage | Max speed |
//! |--------|--------|---------|-----------------------|-------------------|-----------|
//! | ATmega3209-AFR | QFP48 | TQFP48 | -40°C - 105°C | 1.8V - 5V | 20 MHz |
//! | ATmega3209-MFR | QFN48 | UQFN48 | -40°C - 105°C | 1.8V - 5V | 20 MHz |
//!
...
pub const CHANNEL6: *mut u8 = 0x16 as *mut u8;
...
pub const CHANNEL7: *mut u8 = 0x17 as *mut u8;
...
pub mod evsys_channel {
   ...
   pub const CHANNEL6: u32 = 0x7;
   /// Connect user to event channel 7.
   pub const CHANNEL7: u32 = 0x8;
}
